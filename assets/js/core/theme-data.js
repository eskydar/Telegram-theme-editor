define([
   ...
   return {
       ...
       titleShadow: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleBg: {element: 'titleBar', type: 'backgroundColor', color: '', child: '', pseudo: ''},
       titleBgActive: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonBg: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonFg: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonBgOver: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonFgOver: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonBgActive: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonFgActive: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonBgActiveOver: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonFgActiveOver: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleButtonCloseBg: {element: 'titleCloseIcon', type: 'backgroundColor', color: '', child: '', pseudo: ''},
       titleButtonCloseFg: {element: 'titleCloseIcon', type: 'fill', color: '', child: 'svg', pseudo: ''},
       titleButtonCloseBgOver: {element: 'titleCloseIcon', type: 'backgroundColor', color: '', child: '', pseudo: 'hover'},
       titleButtonCloseFgOver: {element: 'titleCloseIcon', type: 'fill', color: '', child: 'svg', pseudo: 'hover'},
       titleButtonCloseBgActive: {element: 'titleCloseIcon', type: 'backgroundColor', color: '', child: '', pseudo: ''},
       titleButtonCloseFgActive: {element: 'titleCloseIcon', type: 'fill', color: '', child: 'svg', pseudo: ''},
       titleButtonCloseBgActiveOver: {element: 'titleCloseIcon', type: 'backgroundColor', color: '', child: '', pseudo: 'hover'},//Need to fix this active shit
       titleButtonCloseFgActiveOver: {element: 'titleCloseIcon', type: 'fill', color: '', child: 'svg', pseudo: 'hover'},//Need to fix this active shit
       titleFg: {element: '', type: '', color: '', child: '', pseudo: ''},
       titleFgActive: {element: '', type: '', color: '', child: '', pseudo: ''},
